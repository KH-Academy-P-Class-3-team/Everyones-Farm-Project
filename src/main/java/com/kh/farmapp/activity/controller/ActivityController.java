...
public class ActivityController {
	...
	public ModelAndView experienceList(@RequestParam(required=false, defaultValue="1") int cPage) {
		...
		Map<String, Object> commandMap = activityService.selectActivityList(cPage, cntPerPage, "experience");
	...
	public ModelAndView helpList(@RequestParam(required=false, defaultValue="1") int cPage) {
		...
		Map<String, Object> commandMap = activityService.selectActivityList(cPage, cntPerPage, "help");
...
//	}
	 ...
	 * 일손돕기 상세보기
	 * @param activityNo - 활동 번호
	 * @retu)rn ModelAndView - Activity, view
	 */
...
//	}
	...
	@ResponseBody
	public ModelAndView searchActivity(String isHelp, String title, String filter) {
		
		Map<String, Object> commandMap = activityService.selectActivitySearch(isHelp, title, filter);
