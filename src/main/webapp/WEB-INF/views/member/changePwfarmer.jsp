...
<div class="pwchange">
	...
	<div class="member">${farmerInfo.name }님, 비밀번호 변경하기<br></div><br>
 	<div class="findmem">
 	<label>비밀번호 * </label><br>
	...
	<input type="hidden" value=${farmerInfo.farmerId } name="farmerId"/>
	<input type="hidden" value=${farmerInfo.email } name="email"/>
