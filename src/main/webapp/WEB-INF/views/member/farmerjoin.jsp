...
<!-- 	 	<input type="text" id="owner" name="owner" /><br> -->
		...
		<div id="err-addr"></div>
	 	...
	 	<div class="why" >
	 	<input type="checkbox" name="farmReason" value="농장 홍보" /> 농장 홍보&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 	<input type="checkbox" name="farmReason" value="농작물 판매" /> 농작물 판매<br>
	 	<input type="checkbox" name="farmReason" value="농장 체험 홍보" /> 농장 체험 홍보&nbsp;&nbsp;&nbsp;
	 	<input type="checkbox" name="farmReason" value="직접 입력" />직접 입력(입력해주세요!)
	 	</div>
	 	<input type="text" name="farmReason" /><br>
	 	농작물(생산품)과 규모 *<br>
	 	<input type="text" id="farmSell" name="farmSell" /><br>
	 	농부로써 가장 중요하다고 생각하는 마음가짐 *<br>
	 	<input type="text" id="farmMind" name="farmMind" /><br>
	 	농장 소개(500자 내외) *<br>
	 	<textarea rows="10" cols="55" style="margin: 7px 7px 12px 7px; border: 1px solid #789F6F; width: 450px;"></textarea><br>
	</div>
	<br>
