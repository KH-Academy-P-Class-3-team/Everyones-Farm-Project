...
<div class="farmer">
	...
	<img alt="farmer" src="<%=request.getContextPath()%>/resources/image/member/man.png" class="person"/>
		...
		<div style="float: left; margin-left: 30px; margin-top: 6px; text-align: center; font-size: 1.1em;">회원님의 아이디는<br> <span class="result" style="font-weight: bolder;">${userInfo.userId } ${farmerInfo.farmerId } </span> 입니다
