...
<label for="checkall"> <span class="check">모두의 농장 이용약관(필수), 개인정보 수집 및 이용(필수), 안내 메일 수신(선택)에 모두 동의합니다</span> </label><br><br>

<input type="checkbox" id="use" name="chk" /> 
<label for="use"><span class="check">모두의 농장 이용약관(필수)</span></label><br>
<textarea>
