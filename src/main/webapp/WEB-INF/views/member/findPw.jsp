...
<div class="user" id="user" style="display:none;">
	<form action="<%=request.getContextPath()%>/user/pwchangemail.do" method="post">
	<div class="member">일반 비밀번호 찾기<br></div>
 	<div class="findmem">
 	<div class="none">아이디 <input type="text" id="userId" name="userId" class="findinput"/></div><br>
	<div class="none">이메일 <input type="text" id="email" name="email" placeholder="  ******@*****.***" class="findinput"/> </div><br>
	<input type="button" value="취소" class="find" id="cancel"/>
	<input type="submit" value="비밀번호 찾기" class="find" id="findpw" />
 	</div>
 	</form>
</div>

<div class="farmer" id="farmer" style="display:none;">
	<form action="<%=request.getContextPath()%>/farmer/pwchangemail.do" method="post">
	<div class="member">농부 비밀번호 찾기<br></div>
 	<div class="findmem">
 	<div class="none">아이디 <input type="text" id="farmerId" name="farmerId" class="findinput"/></div><br>
	<div class="none">이메일 <input type="text" id="email" name="email" placeholder="  ******@*****.***" class="findinput"/> </div><br>
	<input type="button" value="취소" class="find" id="cancel"/>
	<input type="submit" value="비밀번호 찾기" class="find" id="findpw" />
 	</div>
