			...
			<div class="top__member-desc">
				...
				<c:choose>
					...
					<c:when test="${not empty kakaoInfo }">
						...
						<a href="<%=request.getContextPath() %>/user/kakaologout">로그아웃</a><a href="<%=request.getContextPath()%>/mypage/user/modify">마이페이지</a><a href="#"><i class="fas fa-shopping-cart"></i></a><a href="<%=request.getContextPath() %>/search"><i class="fas fa-search"></i></a>
					</c:when>
					<c:when test="${not empty farmerInfo }">

						<a href="<%=request.getContextPath() %>/farmer/logout">로그아웃</a><a href="<%=request.getContextPath()%>/mypage/user/modify">마이페이지</a><a href="<%= request.getContextPath() %>/farmdiary/farmintroduce/farmintroduceForm.do?farmerNo=${farmerInfo.farmerNo}">나의농장</a><a href="#"><i class="fas fa-shopping-cart"></i><a href="<%=request.getContextPath() %>/search"><i class="fas fa-search"></i></a>
