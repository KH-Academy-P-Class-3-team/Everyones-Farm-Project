			...
			<div class="top__member-desc">
				...
				<c:choose>
					...
					<c:when test="${not empty farmerInfo }">
						<a href="<%=request.getContextPath() %>/farmer/logout">로그아웃</a><a href="#">마이페이지</a><a href="<%=request.getContextPath() %>/farmdiary/farmdiarylist.do?farmerNo=${farmerInfo.farmerNo }">나의 농장</a><a href="#"><i class="fas fa-shopping-cart"></i></a><a href="#"><i class="fas fa-search"></i></a>
