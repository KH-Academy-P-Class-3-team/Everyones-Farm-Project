	...
	$("#btnSubPur").click(function(){
		...
		$("#buying").click(function(){
			...
			IMP.request_pay({
	            ...
	            m_redirect_url : '/farmapp/basket/done'
			}, function(rsp) {
	            if ( rsp.success ) {
	                ...
	                //성공시 이동할 페이지
	                location.href='<%=request.getContextPath()%>/mypage/user/modify';
	            } else {
	                msg = '결제에 실패하였습니다.';
	...
	<div class="row">
		<div class="col-lg-3">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<a href="<%=request.getContextPath()%>/mypage/user/basket" style="font-weight: bold;">장바구니</a>
				</div>
				<div class="panel-body">
